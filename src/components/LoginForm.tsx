        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <div className="text-sm text-gray-600">
              <p className="font-medium">Credenziali di test:</p>
              <p>Admin: <code className="bg-gray-100 px-1 rounded">admin / admin123</code></p>
              <p>User: <code className="bg-gray-100 px-1 rounded">user1 / admin123</code></p>
            </div>
          </div>
        </form>
      </div>
