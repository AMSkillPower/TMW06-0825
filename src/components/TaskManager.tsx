...
const TaskManager: React.FC<TaskManagerProps> = () => {
  ...
  const filteredTasks = task.filter((task) => {
    ...
    if (searchTerm.startsWith("stato:")) {
      ...
      if (!descrizione.includes(lowerSearch) && !codiceTask.includes(lowerSearch)) {
        return false;
      }
    }
...
const clientiOptions = clientiList.map((cliente) => ({
  ...
  const safeToLocaleDateString = (date: any): string => {
    try {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (editingTask) {
        ...
        await apiService.updateTask(editingTask.id!.toString(), updatedTask);
    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
        ...
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            placeholder="Cerca task per codice o descrizione..."
            value={searchTerm}
            onChange={(e) => {
        ...
        <div className="relative">
          ...
          <select
            ...
            onChange={(e) => setFilterScadenza(e.target.value as any)}
            className="w-full sm:w-auto pl-10 pr-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm lg:text-base"
          >
                ...
                {filteredTasks.map((task) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">
                          {task.commenti ? task.commenti : "Nessun commento"}
                        </div>
                      </td>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, utente: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm lg:text-base"
                />
              </div>
